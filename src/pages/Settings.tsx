...
import { Moon, Sun, Key, Save, CheckCircle, Shield, RotateCcw } from 'lucide-react';

export default function Settings() {
  const { apiKey, setApiKey, theme, setTheme, setUserName, setRoadmap } = useApp();
  ...
  const confirmReset = () => {
    // Clear state to prevent auto-saving during unload
    setUserName('');
    setRoadmap(null);
